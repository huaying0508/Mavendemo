    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li><a href="javascript:;"> <i class="iconfont left-nav-li" lay-tips="文档管理">&#xe723;</i> <cite>文档管理</cite>
                <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li><a onclick="xadmin.add_tab('文档审核','../doc/docM!findByDoc.action',true)"> <i class="iconfont">&#xe6a7;</i>
                        <cite>文档审核</cite></a></li>
                    <li><a onclick="xadmin.add_tab('文档配置','../admin/DocConfig.jsp',true)"> <i class="iconfont">&#xe6a7;</i>
                        <cite>文档配置</cite></a>
                    </li>
                </ul>
            </li>
